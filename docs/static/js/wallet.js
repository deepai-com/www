...
function e() {
    var t = $(window).scrollTop(), e = t - h;
    h = t, e < 0 ? $("#navbar").removeClass("navbar-bg") : e > 0 && $("#navbar").addClass("navbar-bg")
}

function i() {
    f = document.documentElement.clientHeight, p = f / 2, $(".vp-height").css("height", f + "px")
}

function n(t) {
    g = new ScrollMagic.Scene({
        triggerElement: "#sticky-wrap",
        duration: $("#sticky-wrap").innerHeight() - $("#section-trust").innerHeight(),
        offset: p
    }).setPin("#img-wrap", {pushFollowers: !1}).addTo(d), v = new ScrollMagic.Scene({
        triggerElement: "#section-open",
        duration: f,
        offset: p
    }).setTween("#img-experience", {height: f}).addTo(d), _ = new ScrollMagic.Scene({
        triggerElement: "#section-experience",
        duration: f,
        offset: p
    }).setTween("#img-trust", {height: f}).addTo(d)
}

function r(t) {
    i(), d.destroy(!0), d = new ScrollMagic.Controller, m && m.destroy(!0), g && (g.removePin(!0), g.destroy(!0), $("#img-wrap").css({height: f + "px"})), v && (v.removeTween(!0), v.destroy(!0)), _ && (_.removeTween(!0), _.destroy(!0)), n(t)
}

function o(t, e) {
    return t.complete ? void e(t) : void(t.onload = function () {
        e(t)
    })
}
...
if (!function (t, e) {
        ...
        function X(t, e, i, n) {
            ...
            if (rt.isArray(e)) rt.each(e, function (e, r) {
                i || Ye.test(t) ? n(t, r) : X(t + "[" + ("object" == typeof r ? e : "") + "]", r, i, n)
            }); else if (i || "object" !== rt.type(e)) n(t, e); else for (r in e) X(t + "[" + r + "]", e[r], i, n)
        }
        ...
        var ct = function (t) {
            ...
            var b, w, x, T, S, C, k, A, E, P, D, N, O, R, $, L, M, I, j, F = "sizzle" + 1 * new Date, z = t.document,
                B = 0, H = 0, q = i(), X = i(), U = i(), W = function (t, e) {
                    return t === e && (D = !0), 0
        ...
        var Mt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            ...
            Ht = /<tbody/i, qt = /<|&#?\w+;/, Xt = /<(?:script|style|link)/i, Ut = /checked\s*(?:[^=]|=\s*.checked.)/i,
        ...
        Qt.optgroup = Qt.option, Qt.tbody = Qt.tfoot = Qt.colgroup = Qt.caption = Qt.thead, Qt.th = Qt.td, rt.extend({
            ...
            text: function (t) {
                ...
                return Pt(this, function (t) {
                    ...
                    if (!("string" != typeof t || Xt.test(t) || !it.htmlSerialize && jt.test(t) || !it.leadingWhitespace && Ft.test(t) || Qt[(Bt.exec(t) || ["", ""])[1].toLowerCase()])) {
                        t = t.replace(zt, "<$1></$2>");
                        try {
                ...
                if (p || c > 1 && "string" == typeof f && !it.checkClone && Ut.test(f)) return this.each(function (i) {
                    var n = u.eq(i);
...
+function (t) {
    ...
    function e(i, n) {
        this.$body = t(document.body), this.$scrollElement = t(t(i).is(document.body) ? window : i), this.options = t.extend({}, e.DEFAULTS, n), this.selector = (this.options.target || "") + " .nav li > a", this.offsets = [], this.targets = [],
            this.activeTarget = null, this.scrollHeight = 0, this.$scrollElement.on("scroll.bs.scrollspy", t.proxy(this.process, this)), this.refresh(), this.process()
    }
...
var s = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window;
(s._gsQueue || (s._gsQueue = [])).push(function () {
    ...
    s._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
        ...
        r.version = "1.15.1", c.constructor = r, c.kill()._gc = !1, r.killTweensOf = r.killDelayedCallsTo = i.killTweensOf, r.getTweensOf = i.getTweensOf, r.lagSmoothing = i.lagSmoothing, r.ticker = i.ticker, r.render = i.render, c.invalidate = function () {
            ...
            if (this._initted || o) if (e) this._initted = !1, o && this.render(0, !0, !0); else if (this._gc && this._enabled(!0, !1), this._notifyPluginsOfEnabled && this._firstPT && i._onPluginEvent("_onDisable", this),
        ...
        var n = function (t) {
            ...
            }, r = 1e-10, o = i._internals, a = n._internals = {}, l = o.isSelector, c = o.isArray, u = o.lazyTweens,
            h = o.lazyRender, f = [], p = s._gsDefine.globals, d = function (t) {
                var e, i = {};
                for (e in t) i[e] = t[e];
                return i
        ...
        return n.version = "1.15.1", v.constructor = n, v.kill()._gc = v._forcingPlayhead = !1, v.to = function (t, e, n, r) {
            ...
            var n, o, s, a, l, c = this._dirty ? this.totalDuration() : this._totalDuration, p = this._time,
                d = this._startTime, m = this._timeScale, g = this._paused;
            if (t >= c ? (this._totalTime = this._time = c, this._reversed || this._hasPausedChild() || (o = !0, a = "onComplete", 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (l = !0, this._rawPrevTime > r && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = c + 1e-4) : 1e-7 > t ? (this._totalTime = this._time = 0, (0 !== p || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (a = "onReverseComplete", o = this._reversed), 0 > t ? (this._active = !1, this._rawPrevTime >= 0 && this._first && (l = !0), this._rawPrevTime = t) : (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (l = !0))) : this._totalTime = this._time = this._rawPrevTime = t, this._time !== p && this._first || i || l) {
        ...
        var t = 180 / Math.PI, e = [], i = [], n = [], r = {}, o = s._gsDefine.globals, a = function (t, e, i, n) {
            ...
            c = function (t, e, i, n) {
                ...
                for (e.length = i.length = n.length = 0, p = x.length; --p > -1;) d = x[p], r[d] = -1 !== c.indexOf("," + d + ","), w[d] = h(t, d, r[d], f);
                for (p = e.length; --p > -1;) e[p] = Math.sqrt(e[p]), i[p] = Math.sqrt(i[p]);
                if (!a) {
                    for (p = x.length; --p > -1;) if (r[d]) for (m = w[x[p]], _ = m.length - 1, g = 0; _ > g; g++) v = m[g + 1].da / i[g] + m[g].da / e[g], n[g] = (n[g] || 0) + v * v;
                    for (p = n.length; --p > -1;) n[p] = Math.sqrt(n[p])
                }
                for (p = x.length, g = s ? 4 : 1; --p > -1;) d = x[p], m = w[d], u(m, o, s, a, r[d]), y && (m.splice(0, g), m.splice(m.length - g, g));
                return w
            }, p = function (t, e, i) {
                e = e || "soft";
            ...
            if (t) {
                ...
                e._registerComplexSpecialProp("bezier", {
                    parser: function (t, e, o, s, a, l) {
                        ...
                        for (u in e) m[u] = e[u];
                        return m.values = d, a = new r(t, "bezier", 0, 0, h.pt, 2),
                            a.data = h, a.plugin = l, a.setRatio = n, 0 === m.autoRotate && (m.autoRotate = !0), !m.autoRotate || m.autoRotate instanceof Array || (c = m.autoRotate === !0 ? 0 : Number(m.autoRotate), m.autoRotate = null != h.end.left ? [["left", "top", "rotation", c, !1]] : null != h.end.x && [["x", "y", "rotation", c, !1]]), m.autoRotate && (s._transform || s._enableTransforms(!1), h.autoRotate = s._target._gsTransform), l._onInitTween(h.proxy, m, s._tween), a
                    }
                })
            }
        ...
        }, l = s._gsDefine.globals, c = {}, u = a.prototype = new t("css");
        ...
        var h, f, p, d, m, g, v = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
            ...
            L = 180 / Math.PI, M = {}, I = document, j = function (t) {
                ...
                var o;
                return q || "opacity" !== e ? (!n && t.style[e] ? o = t.style[e] : (i = i || Q(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(k, "-$1").toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == r || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : r) : X(t)
                ...
                return q || (r.opacity = X(t)), n = Rt(t, e, !1), r.rotation = n.rotation, r.skewX = n.skewX, r.scaleX = n.scaleX, r.scaleY = n.scaleY, r.x = n.x, r.y = n.y, kt && (r.z = n.z, r.rotationX = n.rotationX, r.rotationY = n.rotationY, r.scaleZ = n.scaleZ), r.filters && delete r.filters, r
        ...
        var ft = function (t, e, i, n) {
            ...
            this.t = t, this.p = e, this.s = n, this.c = r, this.n = l || e, t instanceof mt || o.push(this.n), this.r = c, this.type = a || 0, u && (this.pr = u, i = !0), this.b = void 0 === h ? n : h, this.e = void 0 === f ? n + r : f, s && (this._next = s, s._prev = this)
            ...
            if (!c[t]) {
                ...
                yt(t, {
                    parser: function (t, i, n, r, o, s, a) {
                        ...
                        return u ? (u._cssRegister(), c[n].parse(t, i, n, r, o, s, a)) : (U("Error: " + e + " js file not loaded."), o)
                    }
                })
            }
        };
        ...
        var wt,
            ...
            At = B.Transform = function () {
                ...
                var o, s, l, c, u, h, f, p, d, m, g = i ? t._gsTransform || new At : new At, v = 0 > g.scaleX, _ = 2e-5,
                    y = 1e5, b = kt ? parseFloat(G(t, Ct, e, !1, "0 0 0").split(" ")[2]) || g.zOrigin || 0 : 0,
                    w = parseFloat(a.defaultTransformPerspective) || 0;
                if (Tt ? s = G(t, St, e, !0) : t.currentStyle && (s = t.currentStyle.filter.match(N), s = s && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), g.x || 0, g.y || 0].join(",") : ""), o = !s || "none" === s || "matrix(1, 0, 0, 1, 0, 0)" === s, g.svg = !!(Et && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)), g.svg && (Ot(t, G(t, Ct, r, !1, "50% 50%") + "", g), wt = a.useSVGTransformAttr || Nt, l = t.getAttribute("transform"), o && l && -1 !== l.indexOf("matrix") && (s = l, o = 0)), !o) {
                    ...
                    if (16 === l.length) {
                        var x, T, S, C, k, A = l[0], E = l[1], P = l[2], D = l[3], O = l[4], R = l[5], $ = l[6], M = l[7],
                            I = l[8], j = l[9], F = l[10], z = l[12], B = l[13], H = l[14], q = l[11], X = Math.atan2($, F);
                        g.zOrigin && (H = -g.zOrigin, z = I * H - l[12], B = j * H - l[13], H = F * H + g.zOrigin - l[14]), g.rotationX = X * L, X && (C = Math.cos(-X), k = Math.sin(-X), x = O * C + I * k, T = R * C + j * k, S = $ * C + F * k, I = O * -k + I * C, j = R * -k + j * C, F = $ * -k + F * C, q = M * -k + q * C, O = x, R = T, $ = S), X = Math.atan2(I, F), g.rotationY = X * L, X && (C = Math.cos(-X), k = Math.sin(-X), x = A * C - I * k, T = E * C - j * k, S = P * C - F * k, j = E * k + j * C, F = P * k + F * C, q = D * k + q * C, A = x, E = T, P = S), X = Math.atan2(E, A), g.rotation = X * L, X && (C = Math.cos(-X), k = Math.sin(-X), A = A * C + O * k, T = E * C + R * k, R = E * -k + R * C, $ = P * -k + $ * C, E = T), g.rotationX && Math.abs(g.rotationX) + Math.abs(g.rotation) > 359.9 && (g.rotationX = g.rotation = 0, g.rotationY += 180), g.scaleX = (0 | Math.sqrt(A * A + E * E) * y + .5) / y, g.scaleY = (0 | Math.sqrt(R * R + j * j) * y + .5) / y, g.scaleZ = (0 | Math.sqrt($ * $ + F * F) * y + .5) / y, g.skewX = 0, g.perspective = q ? 1 / (0 > q ? -q : q) : 0, g.x = z, g.y = B, g.z = H
                    } else if (!(kt && !n && l.length && g.x === l[4] && g.y === l[5] && (g.rotationX || g.rotationY) || void 0 !== g.x && "none" === G(t, "display", e))) {
                        var U = l.length >= 6, W = U ? l[0] : 1, Y = l[1] || 0, V = l[2] || 0, Q = U ? l[3] : 1;
        ...
        u = At.prototype, u.x = u.y = u.z = u.skewX = u.skewY = u.rotation = u.rotationX = u.rotationY = u.zOrigin = u.xPercent = u.yPercent = 0, u.scaleX = u.scaleY = u.scaleZ = 1, yt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser: function (t, e, i, n, o, s, l) {
                ...
                var c, u, h, f, p, d, m, g = n._transform = Rt(t, r, !0, l.parseTransform), v = t.style, _ = 1e-6,
                    y = xt.length, b = l, w = {};
                ...
                for (kt && null != b.force3D && (g.force3D = b.force3D, d = !0), g.skewType = b.skewType || g.skewType || a.defaultSkewType, p = g.force3D || g.z || g.rotationX || g.rotationY || c.z || c.rotationX || c.rotationY || c.perspective, p || null == b.scale || (c.scaleZ = 1); --y > -1;) i = xt[y], f = c[i] - g[i], (f > _ || -_ > f || null != b[i] || null != M[i]) && (d = !0, o = new mt(g, i, g[i], f, o), i in w && (o.e = w[i]), o.xs0 = 0, o.plugin = s, n._overwriteProps.push(o.n));
                return f = b.transformOrigin, f && g.svg && (Ot(t, rt(f), c), o = new mt(g, "xOrigin", g.xOrigin, c.xOrigin - g.xOrigin, o, (-1), "transformOrigin"), o.b = g.xOrigin, o.e = o.xs0 = c.xOrigin, o = new mt(g, "yOrigin", g.yOrigin, c.yOrigin - g.yOrigin, o, (-1), "transformOrigin"), o.b = g.yOrigin, o.e = o.xs0 = c.yOrigin, f = "0px 0px"), (f || kt && p && g.zOrigin) && (Tt ? (d = !0, i = Ct, f = (f || G(t, i, r, !1, "50% 50%")) + "", o = new mt(v, i, 0, 0, o, (-1), "transformOrigin"), o.b = v[i], o.plugin = s, kt ? (h = g.zOrigin, f = f.split(" "), g.zOrigin = (f.length > 2 && (0 === h || "0px" !== f[2]) ? parseFloat(f[2]) : h) || 0, o.xs0 = o.e = f[0] + " " + (f[1] || "50%") + " 0px", o = new mt(g, "zOrigin", 0, 0, o, (-1), o.n), o.b = h, o.xs0 = o.e = g.zOrigin) : o.xs0 = o.e = f) : rt(f + "", g)), d && (n._transformType = g.svg && wt || !p && 3 !== this._transformType ? 2 : 3), o
            }, prefix: !0
        }), yt("boxShadow", {
            ...
            defaultValue: "0px", parser: function (t, e, i, o, s) {
                e = this.format(e);
        ...
        yt("opacity,alpha,autoAlpha", {
            defaultValue: "1", parser: function (t, e, i, n, o, s) {
                var a = parseFloat(G(t, "opacity", r, !1, "1")), l = t.style, c = "autoAlpha" === i;
                return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), c && 1 === a && "hidden" === G(t, "visibility", r) && 0 !== e && (a = 0), q ? o = new mt(l, "opacity", a, e - a, o) : (o = new mt(l, "opacity", 100 * a, 100 * (e - a), o), o.xn1 = c ? 1 : 0, l.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = t, o.plugin = s, o.setRatio = It), c && (o = new mt(l, "visibility", 0, 0, o, (-1), null, (!1), 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit"), o.xs0 = "inherit", n._overwriteProps.push(o.n), n._overwriteProps.push(i)), o
            }
        });
        var jt = function (t, e) {
        ...
        yt("className", {
            parser: function (t, e, n, o, s, a, l) {
                ...
                if (s = o._classNamePT = new mt(t, n, 0, 0, s, 2), s.setRatio = Ft, s.pr = -11, i = !0, s.b = d, u = K(t, r), h = t._gsClassPT) {
                    for (f = {}, p = h.data; p;) f[p.p] = 1, p = p._next;
                    h.setRatio(1)
                }
                return t._gsClassPT = s, s.e = "=" !== e.charAt(1) ? e : d.replace(RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), o._tween._duration && (t.setAttribute("class", s.e), c = tt(t, u, K(t), l, f), t.setAttribute("class", d), s.data = c.firstMPT, t.style.cssText = m, s = s.xfirst = o.parse(t, c.difs, s, a)), s
            }
        });
        var zt = function (t) {
        ...
        u = a.prototype, u._firstPT = u._lastParsedTransform = u._transform = null, u._onInitTween = function (t, e, s) {
            ...
            this._target = t, this._tween = s, this._vars = e, h = e.autoRound, i = !1, n = e.suffixMap || a.suffixMap, r = Q(t, ""), o = this._overwriteProps;
            var l, c, u, d, g, v, _, y, b, w = t.style;
            if (f && "" === w.zIndex && (l = G(t, "zIndex", r), ("auto" === l || "" === l) && this._addLazySet(w, "zIndex", 0)), "string" == typeof e && (d = w.cssText, l = K(t, r), w.cssText = d + ";" + e, l = tt(t, l, K(t)).difs, !q && T.test(e) && (l.opacity = parseFloat(RegExp.$1)), e = l, w.cssText = d), this._firstPT = c = this.parse(t, e, null), this._transformType) {
                for (b = 3 === this._transformType, Tt ? p && (f = !0, "" === w.zIndex && (_ = G(t, "zIndex", r), ("auto" === _ || "" === _) && this._addLazySet(w, "zIndex", 0)), m && this._addLazySet(w, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (b ? "visible" : "hidden"))) : w.zoom = 1, u = c; u && u._next;) u = u._next;
                y = new mt(t, "transform", 0, 0, null, 2), this._linkCSSP(y, null, u), y.setRatio = b && kt ? Lt : Tt ? Mt : $t, y.data = this._transform || Rt(t, r, !0), o.pop()
            }
            if (i) {
                for (; c;) {
            ...
            for (s in e) p = e[s], a = c[s], a ? i = a.parse(t, p, s, this, i, o, e) : (f = G(t, s, r) + "", g = "string" == typeof p, "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || g && C.test(p) ? (g || (p = ut(p), p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"), i = gt(_, s, f, p, !0, "transparent", i, 0, o)) : !g || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (l = parseFloat(f),
                d = l || 0 === l ? f.substr((l + "").length) : "", ("" === f || "auto" === f) && ("width" === s || "height" === s ? (l = nt(t, s, r), d = "px") : "left" === s || "top" === s ? (l = J(t, s, r), d = "px") : (l = "opacity" !== s ? 0 : 1, d = "")), v = g && "=" === p.charAt(1), v ? (u = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), u *= parseFloat(p), m = p.replace(w, "")) : (u = parseFloat(p), m = g ? p.replace(w, "") : ""), "" === m && (m = s in n ? n[s] : d), p = u || 0 === u ? (v ? u + l : u) + m : e[s], d !== m && "" !== m && (u || 0 === u) && l && (l = Z(t, s, l, d), "%" === m ? (l /= Z(t, s, 100, "%") / 100, e.strictUnits !== !0 && (f = l + "%")) : "em" === m ? l /= Z(t, s, 1, "em") : "px" !== m && (u = Z(t, s, u, m), m = "px"), v && (u || 0 === u) && (p = u + l + m)), v && (u += l), !l && 0 !== l || !u && 0 !== u ? void 0 !== _[s] && (p || "NaN" != p + "" && null != p) ? (i = new mt(_, s, u || l || 0, 0, i, (-1), s, (!1), 0, f, p), i.xs0 = "none" !== p || "display" !== s && -1 === s.indexOf("Style") ? p : f) : U("invalid " + s + " tween value: " + e[s]) : (i = new mt(_, s, l, u - l, i, 0, s, h !== !1 && ("px" === m || "zIndex" === s), 0, f, p), i.xs0 = m)) : i = gt(_, s, f, p, !0, null, i, 0, o)), o && i && !i.plugin && (i.plugin = o);
            return i
            ...
            this._transform = this._transform || Rt(this._target, r, !0), this._transformType = this._transform.svg && wt || !t && 3 !== this._transformType ? 2 : 3
        };
        var Bt = function () {
        ...
        var e, i, n, r = s.GreenSockGlobals || s, o = r.com.greensock, a = 2 * Math.PI, l = Math.PI / 2, c = o._class,
            u = function (e, i) {
    ...
    if (!i.TweenLite) {
        ...
        P(), o.play = function (t, e) {
            ...
            if (this._timeline) {
                ...
                this._gc && this._enabled(!0, !1), (this._totalTime !== t || 0 === this._duration) && (this.render(t, e, !1), $.length && X())
            }
            return this
        ...
        var $ = [], L = {}, M = N._internals = {isArray: p, isSelector: O, lazyTweens: $}, I = N._plugins = {},
            ...
            H = E._rootFramesTimeline = new D, q = E._rootTimeline = new D, X = M.lazyRender = function () {
                var t, e = $.length;
                for (L = {}; --e > -1;) t = $[e], t && t._lazy !== !1 && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
                $.length = 0
            };
        q._startTime = s.time, H._startTime = s.frame, q._active = H._active = !0, setTimeout(X, 1), E._updateRoot = N.render = function () {
            var t, e, i;
            if ($.length && X(), q.render((s.time - q._startTime) * q._timeScale, !1, !1), H.render((s.frame - H._startTime) * H._timeScale, !1, !1), $.length && X(), !(s.frame % 120)) {
                for (i in j) {
        ...
        o._init = function () {
            ...
            var o, s, a, l, c, u;
            if (null == e) return !1;
            L[e._gsTweenID] && X(), this.vars.css || e.style && e !== t && e.nodeType && I.css && this.vars.autoCSS !== !1 && R(this.vars, e);
            for (o in this.vars) {
            ...
            return this._notifyPluginsOfEnabled && N._onPluginEvent("_onDisable", this), this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], E.prototype.invalidate.call(this),
            this.vars.immediateRender && (this._time = -u, this.render(-this._delay)), this
        }, o._enabled = function (t, e) {
...
var a = {
    ...
    getDeviceState: function () {
        var t = parseInt(window.getComputedStyle(l).getPropertyValue("z-index"), 10),
...
l.className = "state-indicator", document.body.appendChild(l);
var c = a.getDeviceState(), u = new t;
window.addEventListener("resize", function () {
    var t = a.getDeviceState();
    u.emit("device-resize", t), t !== c && (c = t, u.emit("device-state-change", t))
    ...
    if (a.isWX) {
        ...
        document.body.appendChild(i), i.onload = function () {
            ...
            var n = {
                title: "深度智慧 - 人工智能、区块链与智能制造",
                desc: "深度智慧 - 人工智能、区块链与智能制造",
...
var f = 0, p = 0, d = null, m = null, g = null, v = null, _ = null;
d = new ScrollMagic.Controller, $(document).ready(function () {
    i(), $(".smooth-scroll").click(function (t) {
        var e = this;
    ...
    }), n(a.getDeviceState()), u.on("device-resize", r), a.isMobile ? $(".app-ios").click(function () {
        _hmt.push(["_trackEvent", "btn_ios", "click"]), window.location.href = "https://itunes.apple.com/us/app/bitbill/id1321798216?mt=8"
    }) : $(".app-ios").hover(function () {
        $(this).siblings(".ios-qrcode").show()
    }, function () {
        $(this).siblings(".ios-qrcode").hide()
    }), $(".app-android").click(function () {
        _hmt.push(["_trackEvent", "btn_android", "click"]), window.location.href = "https://www.deepai.com/download/android/bitbill-release-v1_0_0.apk"
    })
}), o(document.getElementById("bg-img"), function (t) {
    $(t).addClass("fadeInUp")
}), $(window).load(function () {
    $("#img-open").addClass("img-open"), $("#img-experience").addClass("img-experience"), $("#img-trust").addClass("img-trust")
});